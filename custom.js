...
const cardsOnce = [
     {
			name: "me-1",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/me-surf.png",
			id: 1,
		},
		{
			name: "me-2",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/me1.png",
			id: 2
		},
		{
			name: "me-3",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/me-jump.png",
			id: 3
		},
		{
			name: "me-4",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/me-pool.png",
			id: 4
		},
		{
			name: "me-5",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/croissant.png",
			id: 5
		},
		{
			name: "me-6",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/me-white.png",
			id: 6
		},
		{
			name: "josh",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/josh.png",
			id: 7
		},
		{
			name: "mano",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/mano2.png",
			id: 8
		},
		{
			name: "mano-lady",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/mano3.png",
			id: 9
		},
		{
			name: "mano-eu",
			img: "https://waddlewaddle.com.au/wp-content/uploads/2021/02/Sem-título-1.png",
			id: 10
		}
];
    var cardArray = jQuery.merge(cardsOnce, cardsOnce);
   ...
   // let imgs;
    ...
    function createBoard(grid, array) {
        ...
        array.forEach((arr, index) => {
            ...
            card.innerHTML = '<div class="inside">\
				...
				<div class="back"><img src="https://waddlewaddle.com.au/wp-content/uploads/2021/02/cover.svg"\
        ...
        if (cardsId.length === 2) {
            setTimeout(checkForMatch, 500);
                for (var i = 0 ; i < cardsId.length; i++) {
                        jQuery(cardsId[i]).addClass("picked");
    ...
    function checkForMatch() {
            ...
            if (cardsSelected[0] === cardsSelected[1] && firstCard == secondCard) {
                ...
                for (var i = 0 ; i < imgs.length; i++) {
                    if (jQuery(imgs[i]).hasClass( "flip" ) && !jQuery(imgs[i]).hasClass("matched")) {
    ...
    function hidePopUpImg() {
        if (jQuery('.memory-game-pop-imgs').is(':visible')) {
            jQuery('.memory-game-pop-imgs').hide();
        }
    }

    function checkWon() {
        if (cardsWon == cardArray.length / 2) {
            setTimeout(()=> jQuery('#win-img-pop').show(),300);
